...
env = SB3QuadrotorEnv(seed=3, quads_render=True, episode_duration=episode_duration, num_agents=num_of_agents, quads_mode="dynamic_same_goal_trajectory")
